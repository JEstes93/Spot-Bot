                ...
                switch (msg.channel.name) {
                        case 'get-roles':
                                U.ChatResponse(msg, "Help\tCommands\n" +
                                        "c!opt-in [...list of roles...]\nCommand will attempt to opt into roles, in order, until the end of a space-separated list. Roles that include spaces may be denoted with quotation marks (\"\").\n\n" +
                                        "c!opt-out [...list of roles...]\nCommand will attempt to opt out of roles, in order, until the end of a space-separated list. Roles that include spaces may be denoted with quotation marks (\"\").\n\n");
                                break;
